...
// Helper to get Base64 image tag
function getScreenshotImg(filePath, caption) {
    try {
        if (fs.existsSync(filePath)) {
            const base64 = fs.readFileSync(filePath, 'base64');
            return `<div style="text-align: center; margin-bottom: 20px;">
                        <img src="data:image/png;base64,${base64}" style="max-width: 100%; height: auto; border: 1px solid #ccc; margin-bottom: 10px;" />
                        <p style="font-style: italic; color: #555;">${caption}</p>
                    </div>`;
        }
    } catch (e) {}
    return `<div style="border: 2px dashed #999; padding: 40px; text-align: center; font-style: italic; color: #666; margin-bottom: 15pt;">
                <h3>[Insert Screenshot Here]</h3>
                <p>${caption}</p>
            </div>`;
}

// Screenshot paths from the previous capture
const ssPaths = [
    'C:\\\\Users\\\\ADMIN\\\\.gemini\\\\antigravity-ide\\\\brain\\\\8330b195-fc82-405c-ab34-5c3a6047a273\\\\home_screen_1787625836463.png',
    'C:\\\\Users\\\\ADMIN\\\\.gemini\\\\antigravity-ide\\\\brain\\\\8330b195-fc82-405c-ab34-5c3a6047a273\\\\projects_screen_1787625873463.png',
    'C:\\\\Users\\\\ADMIN\\\\.gemini\\\\antigravity-ide\\\\brain\\\\8330b195-fc82-405c-ab34-5c3a6047a273\\\\contact_screen_1787625910227.png',
    'C:\\\\Users\\\\ADMIN\\\\.gemini\\\\antigravity-ide\\\\brain\\\\8330b195-fc82-405c-ab34-5c3a6047a273\\\\services_screen_1787625956914.png'
];
...
<head>
    <meta charset="UTF-8">
    <title>Havilah Pro - Final Report Chapters</title>
    <style>
...
<div class="header-container">
    <div>
        <h1 style="text-align: left; margin: 0; text-transform: none;">Havilah Pro - Report Chapters</h1>
        <p style="margin: 0; font-family: Arial;">Chapters 8, 9, and Bibliography</p>
    </div>
...
<div id="export-content">
    ...
    <h2>8.1 Implementation Outcomes</h2>
    ...
    <h2>8.6 Screenshots</h2>
    <p>The following visual evidence demonstrates the completed Graphical User Interface (GUI) of the Havilah platform, captured natively from the browser.</p>

    ${getScreenshotImg(ssPaths[0], 'Figure 8.6.1: The Hero Section of the Home Page, displaying the cinematic background, typography, and initial Framer Motion entrance animations.')}
    
    <div class="page-break"></div>
    ${getScreenshotImg(ssPaths[1], 'Figure 8.6.2: The Projects Portfolio Page, showcasing the responsive CSS Grid layout and hover-state interactions on individual media cards.')}
    
    <div class="page-break"></div>
    ${getScreenshotImg(ssPaths[2], 'Figure 8.6.3: The Contact Form Interface, demonstrating the user input fields, Google Maps integration, and structural layout.')}
    
    <div class="page-break"></div>
    ${getScreenshotImg(ssPaths[3], 'Figure 8.6.4: The Services Page, proving structural responsiveness and correct media alignment.')}
...
<script>
    function exportHTMLToDoc() {
        ...
        fileDownload.download = 'final_report_chapters.doc';
        fileDownload.click();
...
fs.writeFileSync(path.join(__dirname, 'final-report.html'), htmlContent, 'utf-8');
console.log('Successfully generated final-report.html');
